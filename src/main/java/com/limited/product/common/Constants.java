package com.limited.product.common;

public class Constants {
    public static final String SUCCESS = "success";

    public static final String MEMBER_NOT_FOUND_BY_ID = "해당 아이디의 회원이 존재하지 않습니다.";
    public static final String ALREADY_REGISTERED_MEMBER = "이미 가입된 회원입니다.";
    ...
    public static final String PRODUCT_NOT_FOUND = "해당 상품이 존재하지 않습니다.";
}
